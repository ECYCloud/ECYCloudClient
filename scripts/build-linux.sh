...
install -m 0755 "$script_dir/installer/linux/purge-data.sh" \
    "$stage_dir/opt/ecycloud/purge-data.sh"
install -m 0755 "$script_dir/installer/linux/uninstall.sh" \
    "$stage_dir/opt/ecycloud/uninstall.sh"
install -m 0755 "$script_dir/installer/linux/link-libmpv.sh" \
    "$stage_dir/opt/ecycloud/link-libmpv.sh"
...
package_deb() {
    ...
    install -m 0755 "$script_dir/installer/linux/purge-data.sh" "$control_dir/postrm"
...
package_tar() {
    ...
    install -m 0755 "$script_dir/installer/linux/purge-data.sh" "$tar_dir/$tree_name/purge-data.sh"
