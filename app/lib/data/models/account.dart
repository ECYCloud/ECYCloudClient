class AuthOptions {
  const AuthOptions({
    ...
    this.enablePasswordChangeResetSubscription = false,
  ...
  final bool enablePasswordChangeResetSubscription;
  ...
  factory AuthOptions.fromJson(Map<String, dynamic> json) => AuthOptions(
    ...
    enablePasswordChangeResetSubscription:
        json['enable_password_change_reset_subscription'] == true,
...
class DeviceListPage {
  ...
  final List<DeviceListItem> items;
  final int logKeepDays;
  final int currentPage;
  final int lastPage;
  final int total;
  ...
  factory DeviceListPage.fromJson(Map<String, dynamic> json) {
    final Object? raw = json['items'];
    return DeviceListPage(
      items: <DeviceListItem>[
        if (raw is List)
          for (final Object? item in raw)
            if (item is Map<String, dynamic>) DeviceListItem.fromJson(item),
      ],
