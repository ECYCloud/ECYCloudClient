...
class UserProfile {
  const UserProfile({
    ...
    this.deviceKickNotice = false,
    this.deviceKickReason = '',
    this.apiOrigin = '',
    this.siteOrigin = '',
    this.latestAdminReplyAt = '',
  });
  ...
  factory UserProfile.fromJson(Map<String, dynamic> json) => UserProfile(
    ...
    onlineDeviceCount: (json['online_client_count'] as num?)?.toInt() ?? 0,
    onlineDeviceSelf: json['online_client_self'] == true,
    ...
    deviceKickNotice: json['device_kick_notice'] == true,
    deviceKickReason: json['device_kick_reason'] as String? ?? '',
    apiOrigin: json['api_origin'] as String? ?? '',
    siteOrigin: json['site_origin'] as String? ?? '',
    latestAdminReplyAt: json['latest_admin_reply_at'] as String? ?? '',
  );
  ...
  final bool deviceKickNotice;
  final String deviceKickReason;
  final String apiOrigin;
  final String siteOrigin;
  final String latestAdminReplyAt;
  ...
  bool get deviceLimitReached =>
      connectorLimit > 0 && onlineDeviceCount >= connectorLimit && !onlineDeviceSelf;
  ...
  Map<String, dynamic> toJson() => <String, dynamic>{
    ...
    'online_client_count': onlineDeviceCount,
    'online_client_self': onlineDeviceSelf,
    'money': money,
    'last_day_t': lastDayT,
    ...
    'device_kick_notice': deviceKickNotice,
    'device_kick_reason': deviceKickReason,
