...
class RichHtmlView extends StatelessWidget {
  const RichHtmlView(this.html, {super.key, this.imageAlbum, this.textStyle});
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle body = textStyle ?? theme.textTheme.bodyMedium!;
  ...
  static int? _tabOf(String route) => switch (route) {
    ...
    '/user/invite' => ShellNavigator.inviteTab,
