...
class _HomePageState extends State<HomePage> {
  ...
  void didChangeDependencies() {
    ...
    if (_profileTicker == null) {
      ...
      _profileTicker = Timer.periodic(
        ...
        (_) => unawaited(auth.refreshProfile()),
      );
  ...
  Widget build(BuildContext context) {
    ...
    return ListenableBuilder(
      listenable: Listenable.merge(<Listenable>[scope.auth, scope.connection]),
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              _Pair(
                ...
                right: _TrafficCard(connection: connection, upload: false),
              ),
              const SizedBox(height: 10),
...
class _ConnectionCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bool busy = phase == ConnectionPhase.connecting;
              ...
              children: <Widget>[
                ...
                FilledButton.icon(
                  ...
                  style: FilledButton.styleFrom(
                    ...
                    backgroundColor: connected ? AppTheme.danger : null,
                  ),
                ),
              ],
            );
        ...
        children: <Widget>[
          Expanded(
            child: SwitchTile(
              icon: Icons.public,
              title: '系统代理',
              subtitle: '本机 ${settings.mixedPort} 端口',
