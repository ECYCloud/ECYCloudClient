...
class SettingsPage extends StatelessWidget {
    ...
    return ListenableBuilder(
      ...
      builder: (BuildContext context, _) {
        ...
        return ListView(
          ...
          children: <Widget>[
            PageHeader(title: L10n.t('设置'), showUserAvatar: false),
            Padding(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  ListenableBuilder(
                    ...
                    builder: (BuildContext context, _) => Section(
  ...
  static String _perAppSummary(AppSettings settings) =>
      switch (settings.perAppMode) {
        PerAppProxyMode.off => L10n.t('接管全部应用，按当前模式分流'),
