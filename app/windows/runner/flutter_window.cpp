...
FlutterWindow::MessageHandler(HWND hwnd, UINT const message,
  ...
  if (platform_channel_) {
    LRESULT result = 0;
    if (platform_channel_->HandleWindowMessage(message, wparam, lparam,
                                               &result)) {
      return result;
    }
  }
